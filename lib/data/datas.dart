...
const categories = [
  ...
  Category(id: "6", name: "Salata ve Mezeler", color: Colors.blue),
];

// Sabit yemekler listesi
// const meals = [
//   Meal(
//     id: "1",
//     categoryId: "1",
...
//     categoryId: "2",
//     name: "Kaşarlı Mantar",
//     imageUrl: "https://i.nefisyemektarifleri.com/2020/06/03/kasarli-mantar.jpg",
...
//     description: "Kaşarlı tas kebabı tarifi. Mangal ateşinde nefis bir lezzet.",
//     cookingTime: "30-40 dakika",
//   ),
//   Meal(
//     id: "10",
...
// Daha fazla statik veri eklemek veya değiştirmek için bu dosyayı güncelleyebilirsiniz.
// Bu veriler, uygulamanın çalışması sırasında kullanıcıya gösterilen örnek verilerdir.